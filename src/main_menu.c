...
static void NewGameBirchSpeech_CreateDialogueWindowBorder(u8 bg, u8 x, u8 y, u8 width, u8 height, u8 palNum)
{
    ...
    FillBgTilemapBufferRect(bg, BG_TILE_H_FLIP(BIRCH_DLG_BASE_TILE_NUM + 3), x+width-1, y-1, 1,       1, palNum);
    FillBgTilemapBufferRect(bg, BG_TILE_H_FLIP(BIRCH_DLG_BASE_TILE_NUM + 2), x+width,   y-1, 1,       1, palNum);
    FillBgTilemapBufferRect(bg, BIRCH_DLG_BASE_TILE_NUM + 5,                 x-2,       y,   1,       5, palNum);
    FillBgTilemapBufferRect(bg, BIRCH_DLG_BASE_TILE_NUM,                     x-1,       y,   width+1, 5, palNum);
    FillBgTilemapBufferRect(bg, BG_TILE_H_FLIP(BIRCH_DLG_BASE_TILE_NUM + 5), x+width,   y,   1,       5, palNum);
    ...
    FillBgTilemapBufferRect(bg, BG_TILE_V_FLIP(BG_TILE_H_FLIP(BIRCH_DLG_BASE_TILE_NUM + 3)), x+width-1, y+height, 1,       1, palNum);
    FillBgTilemapBufferRect(bg, BG_TILE_V_FLIP(BG_TILE_H_FLIP(BIRCH_DLG_BASE_TILE_NUM + 2)), x+width,   y+height, 1,       1, palNum);
}
