...
{
    FillBgTilemapBufferRect(bg, 0xFE,                  x-2,       y-1, 1,       1, palNum);
    FillBgTilemapBufferRect(bg, 0xFF,                  x-1,       y-1, 1,       1, palNum);
    FillBgTilemapBufferRect(bg, 0x100,                 x,         y-1, width,   1, palNum);
    FillBgTilemapBufferRect(bg, BG_TILE_H_FLIP(0xFF),  x+width-1, y-1, 1,       1, palNum);
    FillBgTilemapBufferRect(bg, BG_TILE_H_FLIP(0xFE),  x+width,   y-1, 1,       1, palNum);
    FillBgTilemapBufferRect(bg, 0x101,                 x-2,       y,   1,       5, palNum);
    FillBgTilemapBufferRect(bg, 0xFC,                  x-1,       y,   width+1, 5, palNum);
    FillBgTilemapBufferRect(bg, BG_TILE_H_FLIP(0x101), x+width,   y,   1,       5, palNum);

    FillBgTilemapBufferRect(bg, BG_TILE_V_FLIP(0xFE),                 x-2,       y+height, 1,       1, palNum);
    ...
    FillBgTilemapBufferRect(bg, BG_TILE_V_FLIP(BG_TILE_H_FLIP(0xFF)), x+width-1, y+height, 1,       1, palNum);
    FillBgTilemapBufferRect(bg, BG_TILE_V_FLIP(BG_TILE_H_FLIP(0xFE)), x+width,   y+height, 1,       1, palNum);
}
