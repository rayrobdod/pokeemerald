...
const u32 DecorTiles_SMALL_DESK[DecorTilesSize] = INCGFX_U32("graphics/decorations/tiles/small_desk.png", ".4bpp");
const u16 DecorMetatiles_SMALL_DESK[] = {
    DECORMETATILE_COVERED(0x5000, BG_TILE_H_FLIP(0x5000), 0x5001, BG_TILE_H_FLIP(0x5001)),
};

const u32 DecorTiles_POKEMON_DESK[DecorTilesSize] = INCGFX_U32("graphics/decorations/tiles/pokemon_desk.png", ".4bpp");
const u16 DecorMetatiles_POKEMON_DESK[] = {
    DECORMETATILE_COVERED(0x2000, BG_TILE_H_FLIP(0x2000), 0x2001, BG_TILE_H_FLIP(0x2001)),
};

const u32 DecorTiles_HEAVY_DESK[DecorTilesSize] = INCGFX_U32("graphics/decorations/tiles/heavy_desk.png", ".4bpp");
...
const u32 DecorTiles_RAGGED_DESK[DecorTilesSize] = INCGFX_U32("graphics/decorations/tiles/ragged_desk.png", ".4bpp");
...
const u32 DecorTiles_COMFORT_DESK[DecorTilesSize] = INCGFX_U32("graphics/decorations/tiles/comfort_desk.png", ".4bpp");
...
const u32 DecorTiles_PRETTY_DESK[DecorTilesSize] = INCGFX_U32("graphics/decorations/tiles/pretty_desk.png", ".4bpp");
...
const u32 DecorTiles_BRICK_DESK[DecorTilesSize] = INCGFX_U32("graphics/decorations/tiles/brick_desk.png", ".4bpp");
...
const u32 DecorTiles_CAMP_DESK[DecorTilesSize] = INCGFX_U32("graphics/decorations/tiles/camp_desk.png", ".4bpp");
...
const u32 DecorTiles_HARD_DESK[DecorTilesSize] = INCGFX_U32("graphics/decorations/tiles/hard_desk.png", ".4bpp");
...
const u32 DecorTiles_SMALL_CHAIR[DecorTilesSize] = INCGFX_U32("graphics/decorations/tiles/small_chair.png", ".4bpp");
const u16 DecorMetatiles_SMALL_CHAIR[] = {
    DECORMETATILE_COVERED(0x2000, 0x2400, 0x2001, 0x2401),
};

const u32 DecorTiles_POKEMON_CHAIR[DecorTilesSize] = INCGFX_U32("graphics/decorations/tiles/pokemon_chair.png", ".4bpp");

const u32 DecorTiles_HEAVY_CHAIR[DecorTilesSize] = INCGFX_U32("graphics/decorations/tiles/heavy_chair.png", ".4bpp");
const u16 DecorMetatiles_HEAVY_CHAIR[] = {
    DECORMETATILE_COVERED(0x4000, 0x4400, 0x4001, 0x4401),
};

const u32 DecorTiles_PRETTY_CHAIR[DecorTilesSize] = INCGFX_U32("graphics/decorations/tiles/pretty_chair.png", ".4bpp");
const u16 DecorMetatiles_PRETTY_CHAIR[] = {
    DECORMETATILE_COVERED(0x4000, 0x4400, 0x4001, 0x4401),
};

const u32 DecorTiles_COMFORT_CHAIR[DecorTilesSize] = INCGFX_U32("graphics/decorations/tiles/comfort_chair.png", ".4bpp");
const u16 DecorMetatiles_COMFORT_CHAIR[] = {
    DECORMETATILE_COVERED(0x5000, 0x5400, 0x5001, 0x5401),
};

const u32 DecorTiles_RAGGED_CHAIR[DecorTilesSize] = INCGFX_U32("graphics/decorations/tiles/ragged_chair.png", ".4bpp");
const u16 DecorMetatiles_RAGGED_CHAIR[] = {
    DECORMETATILE_COVERED(0x5000, 0x5400, 0x5001, 0x5401),
};

const u32 DecorTiles_BRICK_CHAIR[DecorTilesSize] = INCGFX_U32("graphics/decorations/tiles/brick_chair.png", ".4bpp");
const u16 DecorMetatiles_BRICK_CHAIR[] = {
    DECORMETATILE_COVERED(0x4000, 0x4400, 0x4001, 0x4401),
};

const u32 DecorTiles_CAMP_CHAIR[DecorTilesSize] = INCGFX_U32("graphics/decorations/tiles/camp_chair.png", ".4bpp");
const u16 DecorMetatiles_CAMP_CHAIR[] = {
    DECORMETATILE_COVERED(0x5000, 0x5400, 0x5001, 0x5401),
};

const u32 DecorTiles_HARD_CHAIR[DecorTilesSize] = INCGFX_U32("graphics/decorations/tiles/hard_chair.png", ".4bpp");
const u16 DecorMetatiles_HARD_CHAIR[] = {
    DECORMETATILE_COVERED(0x4000, 0x4001, 0x4002, 0x4003),
};

const u32 DecorTiles_RED_PLANT[DecorTilesSize] = INCGFX_U32("graphics/decorations/tiles/red_plant.png", ".4bpp");
...
const u32 DecorTiles_TROPICAL_PLANT[DecorTilesSize] = INCGFX_U32("graphics/decorations/tiles/tropical_plant.png", ".4bpp");
const u16 DecorMetatiles_TROPICAL_PLANT[] = {
    DECORMETATILE_SPLIT(0x5000, 0x5001, 0x5002, 0x5003),
    DECORMETATILE_COVERED(0x5004, 0x5005, 0x5006, 0x5007),
};

const u32 DecorTiles_PRETTY_FLOWERS[DecorTilesSize] = INCGFX_U32("graphics/decorations/tiles/pretty_flowers.png", ".4bpp");
const u16 DecorMetatiles_PRETTY_FLOWERS[] = {
    DECORMETATILE_SPLIT(0x2000, 0x2001, 0x2002, 0x2003),
    DECORMETATILE_COVERED(0x2004, 0x2005, 0x2006, 0x2007),
};

const u32 DecorTiles_COLORFUL_PLANT[DecorTilesSize] = INCGFX_U32("graphics/decorations/tiles/colorful_plant.png", ".4bpp");
...
const u32 DecorTiles_BIG_PLANT[DecorTilesSize] = INCGFX_U32("graphics/decorations/tiles/big_plant.png", ".4bpp");
const u32 DecorTiles_GORGEOUS_PLANT[DecorTilesSize] = INCGFX_U32("graphics/decorations/tiles/gorgeous_plant.png", ".4bpp");
...
const u32 DecorTiles_BRICK[DecorTilesSize] = INCGFX_U32("graphics/decorations/tiles/brick.png", ".4bpp");
...
const u32 DecorTiles_BALLOON[DecorTilesSize] = INCGFX_U32("graphics/decorations/tiles/balloon.png", ".4bpp");
...
const u32 DecorTiles_TENT[DecorTilesSize] = INCGFX_U32("graphics/decorations/tiles/tent.png", ".4bpp");
const u32 DecorTiles_GREEN_TENT[DecorTilesSize] = INCGFX_U32("graphics/decorations/tiles/green_tent.png", ".4bpp");
...
const u32 DecorTiles_SOLID_BOARD[DecorTilesSize] = INCGFX_U32("graphics/decorations/tiles/solid_board.png", ".4bpp");
const u16 DecorMetatiles_SOLID_BOARD[] = {
    DECORMETATILE_COVERED(0x5802, 0x5803, 0x5800, 0x5801),
    DECORMETATILE_COVERED(0x5000, 0x5001, 0x5002, 0x5003),
};

const u32 DecorTiles_SLIDE[DecorTilesSize] = INCGFX_U32("graphics/decorations/tiles/slide.png", ".4bpp");
...
const u32 DecorTiles_FENCE_LENGTH[DecorTilesSize] = INCGFX_U32("graphics/decorations/tiles/fence_length.png", ".4bpp");
const u32 DecorTiles_FENCE_WIDTH[DecorTilesSize] = INCGFX_U32("graphics/decorations/tiles/fence_width.png", ".4bpp");
const u16 DecorMetatiles_FENCE[] = {
    DECORMETATILE_COVERED(0x5000, 0x5400, 0x5001, 0x5401),
};

const u32 DecorTiles_TIRE[DecorTilesSize] = INCGFX_U32("graphics/decorations/tiles/tire.png", ".4bpp");
...
const u32 DecorTiles_STAND[DecorTilesSize] = INCGFX_U32("graphics/decorations/tiles/stand.png", ".4bpp");
...
const u32 DecorTiles_MUD_BALL[DecorTilesSize] = INCGFX_U32("graphics/decorations/tiles/mud_ball.png", ".4bpp");
...
const u32 DecorTiles_BREAKABLE_DOOR[DecorTilesSize] = INCGFX_U32("graphics/decorations/tiles/breakable_door.png", ".4bpp");
...
const u32 DecorTiles_SAND_ORNAMENT[DecorTilesSize] = INCGFX_U32("graphics/decorations/tiles/sand_ornament.png", ".4bpp");
...
const u32 DecorTiles_SILVER_SHIELD[DecorTilesSize] = INCGFX_U32("graphics/decorations/tiles/silver_shield.png", ".4bpp");
const u32 DecorTiles_GOLD_SHIELD[DecorTilesSize] = INCGFX_U32("graphics/decorations/tiles/gold_shield.png", ".4bpp");
...
const u32 DecorTiles_GLASS_ORNAMENT[DecorTilesSize] = INCGFX_U32("graphics/decorations/tiles/glass_ornament.png", ".4bpp");
const u16 DecorMetatiles_GLASS_ORNAMENT[] = {
    DECORMETATILE_SPLIT(0x4000, 0x4001, 0x4002, 0x4003),
    DECORMETATILE_COVERED(0x4004, 0x4005, 0x4006, 0x4007),
};

const u32 DecorTiles_TV[DecorTilesSize] = INCGFX_U32("graphics/decorations/tiles/tv.png", ".4bpp");
const u16 DecorMetatiles_TV[] = {
    DECORMETATILE_COVERED(0x4000, 0x4001, 0x4002, 0x4003),
};

const u32 DecorTiles_ROUND_TV[DecorTilesSize] = INCGFX_U32("graphics/decorations/tiles/round_tv.png", ".4bpp");
const u16 DecorMetatiles_ROUND_TV[] = {
    DECORMETATILE_COVERED(0x5000, 0x5001, 0x5002, 0x5003),
};

const u32 DecorTiles_CUTE_TV[DecorTilesSize] = INCGFX_U32("graphics/decorations/tiles/cute_tv.png", ".4bpp");
const u16 DecorMetatiles_CUTE_TV[] = {
    DECORMETATILE_COVERED(0x1000, 0x1001, 0x1002, 0x1003),
};

const u32 DecorTiles_GLITTER_MAT[DecorTilesSize] = INCGFX_U32("graphics/decorations/tiles/glitter_mat.png", ".4bpp");
const u16 DecorMetatiles_GLITTER_MAT[] = {
    DECORMETATILE_COVERED(0x4000, 0x4001, 0x4002, 0x4003),
};

const u32 DecorTiles_JUMP_MAT[DecorTilesSize] = INCGFX_U32("graphics/decorations/tiles/jump_mat.png", ".4bpp");
const u16 DecorMetatiles_JUMP_MAT[] = {
    DECORMETATILE_COVERED(0x4000, 0x4400, 0x4001, 0x4401),
};

const u32 DecorTiles_SPIN_MAT[DecorTilesSize] = INCGFX_U32("graphics/decorations/tiles/spin_mat.png", ".4bpp");
const u16 DecorMetatiles_SPIN_MAT[] = {
    DECORMETATILE_COVERED(0x3000, 0x3001, 0x3002, 0x3003),
};

const u32 DecorTiles_NOTE_MAT[DecorTilesSize] = INCGFX_U32("graphics/decorations/tiles/note_mat.png", ".4bpp");
const u16 DecorMetatiles_NOTE_MAT[] = {
    DECORMETATILE_COVERED(0x4000, 0x4001, 0x4002, 0x4003),
};

const u32 DecorTiles_SURF_MAT[DecorTilesSize] = INCGFX_U32("graphics/decorations/tiles/surf_mat.png", ".4bpp");
const u32 DecorTiles_THUNDER_MAT[DecorTilesSize] = INCGFX_U32("graphics/decorations/tiles/thunder_mat.png", ".4bpp");
const u32 DecorTiles_FIRE_BLAST_MAT[DecorTilesSize] = INCGFX_U32("graphics/decorations/tiles/fire_blast_mat.png", ".4bpp");
const u32 DecorTiles_POWDER_SNOW_MAT[DecorTilesSize] = INCGFX_U32("graphics/decorations/tiles/powder_snow_mat.png", ".4bpp");
const u32 DecorTiles_ATTRACT_MAT[DecorTilesSize] = INCGFX_U32("graphics/decorations/tiles/attract_mat.png", ".4bpp");
const u32 DecorTiles_FISSURE_MAT[DecorTilesSize] = INCGFX_U32("graphics/decorations/tiles/fissure_mat.png", ".4bpp");
const u32 DecorTiles_SPIKES_MAT[DecorTilesSize] = INCGFX_U32("graphics/decorations/tiles/spikes_mat.png", ".4bpp");
const u32 DecorTiles_WATERMELON_MAT[DecorTilesSize] = INCGFX_U32("graphics/decorations/tiles/watermelon_mat.png", ".4bpp");
const u32 DecorTiles_POKEBALL_MAT[DecorTilesSize] = INCGFX_U32("graphics/decorations/tiles/pokeball_mat.png", ".4bpp");
...
const u32 DecorTiles_BALL_POSTER[DecorTilesSize] = INCGFX_U32("graphics/decorations/tiles/ball_poster.png", ".4bpp");
const u32 DecorTiles_GREEN_POSTER[DecorTilesSize] = INCGFX_U32("graphics/decorations/tiles/green_poster.png", ".4bpp");
const u32 DecorTiles_RED_POSTER[DecorTilesSize] = INCGFX_U32("graphics/decorations/tiles/red_poster.png", ".4bpp");
const u32 DecorTiles_BLUE_POSTER[DecorTilesSize] = INCGFX_U32("graphics/decorations/tiles/blue_poster.png", ".4bpp");
const u32 DecorTiles_CUTE_POSTER[DecorTilesSize] = INCGFX_U32("graphics/decorations/tiles/cute_poster.png", ".4bpp");
...
const u32 DecorTiles_PIKA_POSTER[DecorTilesSize] = INCGFX_U32("graphics/decorations/tiles/pika_poster.png", ".4bpp");
const u32 DecorTiles_LONG_POSTER[DecorTilesSize] = INCGFX_U32("graphics/decorations/tiles/long_poster.png", ".4bpp");
const u32 DecorTiles_SEA_POSTER[DecorTilesSize] = INCGFX_U32("graphics/decorations/tiles/sea_poster.png", ".4bpp");
const u32 DecorTiles_SKY_POSTER[DecorTilesSize] = INCGFX_U32("graphics/decorations/tiles/sky_poster.png", ".4bpp");
const u32 DecorTiles_KISS_POSTER[DecorTilesSize] = INCGFX_U32("graphics/decorations/tiles/kiss_poster.png", ".4bpp");
const u32 DecorTiles_DADS_SCROLL[DecorTilesSize] = INCGFX_U32("graphics/decorations/tiles/dads_scroll.png", ".4bpp");
const u32 DecorTiles_REGION_MAP[DecorTilesSize] = INCGFX_U32("graphics/decorations/tiles/region_map.png", ".4bpp");
...
const u32 DecorTiles_SMALL_BOOKSHELF[DecorTilesSize] = INCGFX_U32("graphics/decorations/tiles/small_bookshelf.png", ".4bpp");
const u32 DecorTiles_BIG_BOOKSHELF[DecorTilesSize] = INCGFX_U32("graphics/decorations/tiles/big_bookshelf.png", ".4bpp");
...
const u32 DecorTiles_CANDLESTICK[DecorTilesSize] = INCGFX_U32("graphics/decorations/tiles/candlestick.png", ".4bpp");
...
const u32 DecorTiles_ICY_DESK[DecorTilesSize] = INCGFX_U32("graphics/decorations/tiles/icy_desk.png", ".4bpp");


const u32 DecorTiles_BONSAI[DecorTilesSize] = INCGFX_U32("graphics/decorations/tiles/bonsai.png", ".4bpp");
const u16 DecorMetatiles_BONSAI[] = {
    DECORMETATILE_COVERED(0x5000, 0x5001, 0x5002, 0x5003),
};

const u32 DecorTiles_CUPBOARD[DecorTilesSize] = INCGFX_U32("graphics/decorations/tiles/cupboard.png", ".4bpp");
...
const u32 DecorTiles_WOOD_DRESSER[DecorTilesSize] = INCGFX_U32("graphics/decorations/tiles/wood_dresser.png", ".4bpp");

const u32 DecorTiles_PINK_DRESSER[DecorTilesSize] = INCGFX_U32("graphics/decorations/tiles/pink_dresser.png", ".4bpp");
...
const u32 DecorTiles_REFRIGERATOR[DecorTilesSize] = INCGFX_U32("graphics/decorations/tiles/refrigerator.png", ".4bpp");
const u16 DecorMetatiles_REFRIGERATOR[] = {
    DECORMETATILE_SPLIT(0x4000, 0x4001, 0x4002, 0x4003),
    DECORMETATILE_COVERED(0x4004, 0x4005, 0x4006, 0x4007),
};

const u32 DecorTiles_PRETTY_SINK[DecorTilesSize] = INCGFX_U32("graphics/decorations/tiles/pretty_sink.png", ".4bpp");
