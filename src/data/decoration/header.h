const struct Decoration gDecorations[NUM_DECORATIONS_PLUS_ONE] =
{
    [DECOR_NONE] =
    {
        ...
        .icon = {gItemIcon_QuestionMark, gDecorIconPalette_QuestionMark},
    ...
    [DECOR_SMALL_BOOKSHELF] =
    {
        ...
        .icon = {gDecorIcon_SmallBookshelf, gDecorIconPalette_SmallBookshelf},
        .metatiles = DecorMetatiles_TROPICAL_PLANT,
        .attributes = DecorAttributes_Plant_1x2,
    },
    ...
    [DECOR_BIG_BOOKSHELF] =
    {
        ...
        .icon = {gDecorIcon_BigBookshelf, gDecorIconPalette_BigBookshelf},
        .metatiles = DecorMetatiles_COLORFUL_PLANT,
        .attributes = DecorAttributes_Plant_2x2,
    },
    ...
    [DECOR_GREEN_TENT] =
    {
        ...
        .icon = {gDecorIcon_GreenTent, gDecorIconPalette_GreenTent},
    ...
    [DECOR_DADS_SCROLL] =
    {
        ...
        .icon = {gDecorIcon_DadsScroll, gDecorIconPalette_DadsScroll},
        .metatiles = DecorMetatiles_POSTER_2x1_PAL1,
        .attributes = DecorAttributes_Poster_2x1,
    },
    ...
    [DECOR_CANDLESTICK] =
    {
        ...
        .icon = {gDecorIcon_Candlestick, gDecorIconPalette_Candlestick},
    ...
    [DECOR_ICY_DESK] =
    {
        ...
        .icon = {gDecorIcon_IcyDesk, gDecorIconPalette_IcyDesk},
    ...
    [DECOR_CUPBOARD] =
    {
        ...
        .icon = {gDecorIcon_Cupboard, gDecorIconPalette_Cupboard},
    ...
    [DECOR_WOOD_DRESSER] =
    {
        ...
        .icon = {gDecorIcon_WoodDresser, gDecorIconPalette_WoodDresser},
        .metatiles = DecorMetatiles_COLORFUL_PLANT,
        .attributes = DecorAttributes_Plant_2x2,
    },
    ...
    [DECOR_PINK_DRESSER] =
    {
        ...
        .icon = {gDecorIcon_PinkDresser, gDecorIconPalette_PinkDresser},
    ...
    [DECOR_REFRIGERATOR] =
    {
        ...
        .icon = {gDecorIcon_Refrigerator, gDecorIconPalette_Refrigerator},
    ...
    [DECOR_PRETTY_SINK] =
    {
        ...
        .icon = {gDecorIcon_PrettySink, gDecorIconPalette_PrettySink},
    ...
    [DECOR_WATERMELON_MAT] =
    {
        ...
        .icon = {gDecorIcon_WatermelonMat, gDecorIconPalette_WatermelonMat},
        .metatiles = DecorMetatiles_MAT_3x3_PAL2,
        .attributes = DecorAttributes_Mat_3x3,
    },
    ...
    [DECOR_POKEBALL_MAT] =
    {
        ...
        .icon = {gDecorIcon_PokeballMat, gDecorIconPalette_PokeballMat},
