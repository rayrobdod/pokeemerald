...
const u16 gDecorIconPalette_SmallBookshelf[] = INCBIN_U16("graphics/decorations/small_bookshelf.gbapal");
...
const u16 gDecorIconPalette_Candlestick[] = INCBIN_U16("graphics/decorations/candlestick.gbapal");
