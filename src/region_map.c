...
static const u16 sRegionMapBg_Pal[] = INCBIN_U16("build/assets/graphics/region_map/hoenn_base.gbapal");
static const u32 sRegionMapBg_GfxLZ[] = INCBIN_U32("build/assets/graphics/region_map/hoenn_affine.8bpp.lz");
static const u32 sRegionMapBg_TilemapLZ[] = INCBIN_U32("build/assets/graphics/region_map/hoenn_affine.tilemap.lz");
