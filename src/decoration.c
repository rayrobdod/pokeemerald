...
static void ShowDecorationOnMap_(u16 mapX, u16 mapY, u8 decWidth, u8 decHeight, u32 decorIdx, u16 decoration)
{
    ...
    assertf(0 < decHeight * decWidth, "Invalid decoration size: %d * %d", decHeight, decWidth)
    {
        return;
    }
...
{
    ShowDecorationOnMap_(mapX, mapY, sDecorShapes[gDecorations[decoration].shape].width, sDecorShapes[gDecorations[decoration].shape].height, decorIdx, decoration);
}
