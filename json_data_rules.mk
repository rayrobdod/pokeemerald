...
AUTO_GEN_TARGETS += $(DATA_SRC_SUBDIR)/credits.h
$(DATA_SRC_SUBDIR)/credits.h: $(DATA_SRC_SUBDIR)/credits.json $(DATA_SRC_SUBDIR)/credits.inja
	$(JSONPROC) $^ $@

$(C_BUILDDIR)/credits.o: c_dep += $(DATA_SRC_SUBDIR)/credits.h
