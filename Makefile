...
TILEMAPCOMP4 := $(TOOLS_DIR)/compressTilemap4/compressTilemap4$(EXE)
...
clean-assets:
	...
	find . \( -iname '*.1bpp' -o -iname '*.4bpp' -o -iname '*.8bpp' -o -iname '*.gbapal' -o -iname '*.lz' -o -iname '*.rl' -o -iname '*.tilemapcomp4_8' -o -iname '*.tilemapcomp4_16' -o -iname '*.latfont' -o -iname '*.hwjpnfont' -o -iname '*.fwjpnfont' \) -exec rm {} +
...
%.lz:     %      ; $(GFX) $< $@
%.rl:     %      ; $(GFX) $< $@
%.tilemapcomp4_8: % $(TILEMAPCOMP4) ; $(TILEMAPCOMP4) -8 $< $@
%.tilemapcomp4_16: % $(TILEMAPCOMP4) ; $(TILEMAPCOMP4) $< $@
